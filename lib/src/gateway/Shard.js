        ...
        this.ws.on('message', async (data) => {
            try {
                ...
                if (d?.user) {
                    ...
                    this.client.user = new BotUser_1.default(clientUser.id, clientUser.username, clientUser.discriminator, clientUser.avatar, clientUser.verified, clientUser.flags);
                }
                switch (op) {
                    case 9:
