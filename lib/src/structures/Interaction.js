...
class Interaction {
    ...
    _message;
    timestamp;
    constructor(bot, token, version, _id, _application_id, _type, _guild, _channel, _data, _member, _user, _message) {
        this.bot = bot;
        this.token = token;
    ...
    reply(data, type = 4) {
        ...
        this.bot.requestHandler('POST', `${Constants_1.EndPoints.interactions}/${this.id}/${this.token}/${Constants_1.EndPoints.callback}`, {
            type,
            data
        });
    }
