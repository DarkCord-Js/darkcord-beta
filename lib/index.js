...
const LavaLink_1 = tslib_1.__importDefault(require("./src/voice/LavaLink"));
const VoiceState_1 = tslib_1.__importDefault(require("./src/structures/VoiceState"));
const VoiceChannel_1 = tslib_1.__importDefault(require("./src/structures/channels/VoiceChannel"));
const Permissions_1 = tslib_1.__importDefault(require("./src/util/Permissions"));
const Emojis_1 = tslib_1.__importDefault(require("./src/util/Emojis/Emojis"));
exports.default = {
    Bot: Bot_1.default,
